...
export const OVERLAY_SOURCES: OverlaySource[] = [
  ...
  },
  {
    ...
    name: "Scorebug",
    size: "1920 × 1080",
    note: "Always-on names, score, resources. VGC / PTCG / YGO / OP / Lorcana Play Layout, ROK Layout on other titles.",
  },
  {
    id: "versus",
    path: "/overlay/versus",
    name: "Versus",
    size: "1920 × 1080",
    note: "Full-frame match intro. VGC: split cams, both teams, event logo. Cut to this between games.",
  },
  {
    id: "slate",
    path: "/overlay/slate",
  ...
  },
  {
    ...
    name: "Match clock",
    size: "1920 × 1080",
    note: "Full-screen clock for a monitor at that table. Stream, Floor 1, and Floor 2 each have their own timer. The room-wide floor clock stays on Tournament.",
  },
  {
    id: "roster",
    path: "/overlay/roster",
